    ...
    with col1:
        ...
        with st.chat_message("assistant"):
            ...
            if endpoint_type == EndpointType.PROMPTFLOW:
                ...
                stream = get_os_stream_response(EndpointType.AZUREML, nim_off_endpoints[EndpointType.AZUREML], messages[-3:])
            else:
    ...
    with col2:
        ...
        with st.chat_message("assistant"):
            ...
            if endpoint_type == EndpointType.PROMPTFLOW:
                ...
                stream = get_nim_stream_response(EndpointType.AZUREML, nim_on_endpoints[EndpointType.AZUREML], messages[-3:])
            else:
